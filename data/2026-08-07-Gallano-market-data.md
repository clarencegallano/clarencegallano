...
| `R_FC` | 2.884% | Euribor-rates.eu, 12-month Euribor — https://www.euribor-rates.eu/en/current-euribor-rates/4/euribor-rate-12-months/ | Per the assignment's own source guidance. 12-month Euribor — not a German Bund yield — is the rate that actually prices EUR/USD FX forwards in practice, since FX-forward dealers fund off interbank curves, not sovereign curves. |
